...
public class QuizSelection : MonoBehaviour
{
    ...
    public static string question = "Generate any easy MCQ question related to Traffic Rules. Display options by line break and correct option should always be a) option and the remaining 3 options incorrect e.g. for b) , c) and d) generate incorrect answers.";
    ...
    /*private void QuestionSelected(int index)
    {
        question = "Generate any easy MCQ question related to Traffic Rules. Display options by line break and correct option should always be a) option and the remaining 3 options incorrect e.g. for b) , c) and d) generate incorrect answers.";
        image = "Image of" + questionType.options[index].text;
    }*/
